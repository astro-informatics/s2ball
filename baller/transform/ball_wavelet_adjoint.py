...
from baller.construct import wavelet_constructor
from baller.transform import laguerre, wigner_laguerre
...
def forward_transform(
    ...
    f_scal_lmp = laguerre.forward_transform(
        f_scal, leg_kernels[1], lag_polys[1]
    )
...
def forward_transform_jax(
    ...
    f_scal_lmp = laguerre.forward_transform_jax(
        f_scal, leg_kernels[1], lag_polys[1]
    )
...
def inverse_transform(
    ...
    f_scal = laguerre.inverse_transform(
        f_scal_lmp, leg_kernels[0], lag_polys[0]
    )
...
def inverse_transform_jax(
    ...
    f_scal = laguerre.inverse_transform_jax(
        f_scal_lmp, leg_kernels[0], lag_polys[0]
    )
